...
The `hcl_converter` function provides a simple way to simulate
...
```{r, engine = "python", fig.width = 8, fig.height = 2.8}
from colorspace.hcl_converter import hcl_converter
hcl_converter(cvd = ['original','deutan','desaturate'], severity = 1)
```
...
```{r, engine = "python", fig.width = 8, fig.height = 2.8}
from colorspace.hcl_converter import hcl_converter
hcl_converter(cvd = ['deutan', 'protan', 'tritan'], severity = .8)
```
