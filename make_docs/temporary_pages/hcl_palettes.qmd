...
* "Blue-Red" to "Cyan-Magenta" have been developed for **colorspace** starting from
  @color:Zeileis+Hornik+Murrell:2009, taking inspiration from various other
...
TODO: I do not have the same order as I do not mix basic and advanced.
...
divergingx_palettes(ncol = 1, plot = True, figsize = (8, 10))
```
