...
# - DATE:        2018-09-17
# -------------------------------------------------------------------
# - DESCRIPTION: Creates a gif with a rotating HCL space for
#                visualization purposes.
# -------------------------------------------------------------------
# - EDITORIAL:   2018-09-17, RS: Created file on thinkreto.
# -------------------------------------------------------------------
# - L@ST MODIFIED: 2018-09-17 11:26 on marvin
# -------------------------------------------------------------------
...
p = sub.Popen(["convert","-delay","7","_fig*.png","HCL_space.gif"],
               stdout = sub.PIPE, stderr = sub.PIPE)
out,err = p.communicate()
if p.returncode == 0:
    print("All fine, HCL_space.gif created")
    import os
