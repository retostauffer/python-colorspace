...
To easily create custom effective color palettes ... perceptual dimensions ...
HCL color model.

Introduce the HCL color model as we need it to understand the rest.

Besides being able to create palettes, _colorspace_ also provides functionality
for assessing colors and integrate it into existing workflows and plotting libraries.
