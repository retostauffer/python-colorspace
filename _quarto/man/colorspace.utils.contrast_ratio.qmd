...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Single hex color (str), a list of hex colors (list),
a color object ,
or [palette](colorspace.palettes.palette.qmd).)</dd>
 ...
 <dd>escape(background color against which the contrast will be calculated.
Defaults to white (`"#FFFFFF"`).)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.utils.contrast_ratio:plot">plot</code><code class="argument-class">bool</code>
  </dt>
 <dd>escape(logical indicating whether the contrast ratios should also be
visualized by simple color swatches.)</dd>
 ...
 <dd>escape(If None, a new matplotlib figure will
...
Forwarded to different plot types.)</dd>
 ...
 <dd>escape(size of text, forwarded to `matplotlib.pyplot.text`.
