...
explicitly set via the [set_whitepoint](colorspace.colorlib.HSV.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>HSV.get_whitepoint()</code></pre>
