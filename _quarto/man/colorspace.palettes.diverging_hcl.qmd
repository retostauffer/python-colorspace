...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Hue values (color), diverging color palettes should
...
parameter).)</dd>
 ...
 <dd>escape(Chroma value (colorfullness), a single numeric value. If two
values are provided the first will be taken as `c1`, the second as `cmax`.)</dd>
 ...
 <dd>escape(luminance values (lightness). The first value is for
