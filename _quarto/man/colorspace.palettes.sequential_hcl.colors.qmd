...
<pre><code class='language-python'>sequential_hcl.colors(n=11, fixup=None, alpha=None,<br/>                      **kwargs)</code></pre>
...
`False` to explicitly control the fixup here.</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.sequential_hcl.colors:alpha">alpha</code><code class="argument-class">None, float, list, or numpy.ndarray</code>
  </dt>
