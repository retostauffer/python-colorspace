...
<dl class="pyp-list param-list">
 ...
 <dd>escape(The colors, any type which can be handled by 
[palette](colorspace.palettes.palette.qmd).)</dd>
 ...
 <dd>escape(Name of the demo function to be called.
Not case sensitive.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.demos.demoplot:n">n</code><code class="argument-class">int</code>
  </dt>
 <dd>escape(Number of colors for the plot. Only used if argument `colors`
...
Defaults to 7.)</dd>
 ...
 <dd>escape(used to draw the figure title, if specified (str).
...
Forwarded to different plot types.)</dd>
 ...
 <dd>escape(Forwarded to the corresponding demo plot functions.)</dd>
</dl>
