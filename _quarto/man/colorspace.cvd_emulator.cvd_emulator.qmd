...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Name of the figure which should be converted
(png/jpg/jpeg). If `image = "DEMO"` the package demo figure is used.)</dd>
 ...
 <dd>escape(Color vision deficiency or deficiencies. Allowed types are
...
and `"original"` (unmodified).)</dd>
 ...
 <dd>escape(How severe the color vision deficiency is
...
includes `"desaturate"`.)</dd>
 ...
 <dd>escape(If `None` an interactive plotting window will
...
to disc.)</dd>
 ...
 <dd>escape(Drop alpha channel, defaults to `False`.  Only
