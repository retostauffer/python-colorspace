...
<pre><code class='language-python'>rainbow_hcl(c=50, l=70, start=0,<br/>            end=&lt;function rainbow_hcl.&lt;lambda&gt; at 0x752c6ca8bce0&gt;,<br/>            gamma=None, fixup=True, rev=False,<br/>            *args, **kwargs)</code></pre>
