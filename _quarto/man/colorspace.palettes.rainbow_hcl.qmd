...
<pre><code class='language-python'>rainbow_hcl(c=50, l=70, start=0,<br/>            end=&lt;function rainbow_hcl.&lt;lambda&gt; at 0x71307a389620&gt;,<br/>            gamma=None, fixup=True, rev=False,<br/>            *args, **kwargs)</code></pre>
...
with one argument. Defaults to 0.)</dd>
 ...
 <dd>escape(Hue (int) at which the rainbow should end or lambda function
...
RGB values outside the defined RGB color space be corrected?)</dd>
 ...
 <dd>escape(Processed internally; can be used to overwrite `h1`,
