...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Hue values, diverging color palettes should have
...
parameter).)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.diverging_hsv:s">s</code><code class="argument-class">float</code>
  </dt>
 <dd>escape(Saturation value for the two ends of the palette.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.diverging_hsv:v">v</code><code class="argument-class">float</code>
  </dt>
 <dd>escape(Value (the HSV value) of the two ends of the palette.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.diverging_hsv:power">power</code><code class="argument-class">numeric</code>
  </dt>
 <dd>escape(Power parameter for non-linear behaviour of the color
palette.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
...
<dl class="pyp-list method-list">
    <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
       <code>[diverging_hsv.cmap(n=101, name=&#x27;custom_hcl_cmap&#x27;)](colorspace.palettes.diverging_hsv.cmap.qmd)</code>
    </dt>
    <dd>Get matplotlib Compatible Color Map</dd>
    <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
       <code>[diverging_hsv.colors(n=11, fixup=True, **kwargs)](colorspace.palettes.diverging_hsv.colors.qmd)</code>
    </dt>
    <dd>Get Colors</dd>
    <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
