...
<pre><code class='language-python'>qualitative_hcl(h=[0, &lt;function qualitative_hcl.&lt;lambda&gt; at 0x71ba34a837e0&gt;],<br/>                c=80, l=60, fixup=True,<br/>                palette=None, rev=False, **kwargs)</code></pre>
...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Hue values defining the 'color'. Qualitative color
...
one single argument `n` (number of colors; see default value).)</dd>
 ...
 <dd>escape(Chroma value (colorfullness), a single numeric value. If
multiple values are provided only the first one will be used.)</dd>
 ...
 <dd>escape(luminance value (lightness), a single numeric value. If
multiple values are provided only the first one will be used.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
...
values outside the defined RGB color space be corrected?)</dd>
 ...
 <dd>escape(Can be used to load a default diverging color
...
qthe color palette.)</dd>
 ...
 <dd>escape(Should the color map be reversed? Default `False`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.qualitative_hcl:**kwargs">**kwargs</code>
  </dt>
 <dd>escape(Additional arguments to overwrite the h/c/l settings. TODO: has to be documented.)</dd>
</dl>
