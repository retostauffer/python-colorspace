...
explicitly set via the [set_whitepoint](colorspace.colorlib.CIELAB.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>CIELAB.get_whitepoint()</code></pre>
