...
explicitly set via the [set_whitepoint](colorspace.colorlib.polarLAB.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>polarLAB.get_whitepoint()</code></pre>
