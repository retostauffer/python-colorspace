...
<dl class="pyp-list param-list">
 ...
 <dd>escape(The color palettes or color objects to be visualized.
...
usages.)</dd>
 ...
 <dd>escape(Should palette names be shown (if available), defaults to True.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.swatchplot.swatchplot:nrow">nrow</code><code class="argument-class">int</code>
  </dt>
 <dd>escape(Maximum number of rows of swatches, defaults to `20`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.swatchplot.swatchplot:n">n</code><code class="argument-class">int</code>
  </dt>
 <dd>escape(Number of colors to be drawn from palette objects, defaults to `5`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.swatchplot.swatchplot:cvd">cvd</code><code class="argument-class">None or list</code>
  </dt>
 <dd>escape(Allows to display one or multiple palettes and how they look
...
[desaturate](colorspace.CVD.desaturate.qmd).)</dd>
 ...
 <dd>escape(forwarded to `matplotlib.pyplot.subplot`, can be used to control e.g.,
`figsize`.)</dd>
</dl>
