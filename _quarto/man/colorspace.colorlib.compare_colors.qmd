...
<dl class="pyp-list param-list">
 ...
 <dd>escape(Object which inherits from `colorobject`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
 ...
 <dd>escape(Default `False`, check for colors being nearly equal
...
(colorspace.colorlib.hexcols) strings will always be matched exactly.)</dd>
 ...
 <dd>escape(Default `True`; the function will return `True` if
...
pair of colors.)</dd>
 ...
 <dd>escape(Absolute tolerance for the distance measure
...
<li><code class="text-warning">ValueError</code>: If `exact` or `_all` are not bool.
<li><code class="text-warning">ValueError</code>: If `atol` is neither `None` nor float.
</ul>
