...
explicitly set via the [set_whitepoint](colorspace.colorlib.HCL.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>HCL.get_whitepoint()</code></pre>
