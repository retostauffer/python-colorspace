...
explicitly set via the [set_whitepoint](colorspace.colorlib.CIELUV.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>CIELUV.get_whitepoint()</code></pre>
