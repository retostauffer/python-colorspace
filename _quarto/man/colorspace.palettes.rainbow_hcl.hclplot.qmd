...
<pre><code class='language-python'>rainbow_hcl.hclplot(n=7, **kwargs)</code></pre>

### Arguments

<dl class="pyp-list param-list">
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.rainbow_hcl.hclplot:n">n</code><code class="argument-class">int</code>
  </dt>
 <dd>Number of colors, defaults to 7.</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.palettes.rainbow_hcl.hclplot:**kwargs">**kwargs</code>
  </dt>
