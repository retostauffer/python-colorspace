...
<dl class="pyp-list param-list">
 ...
 <dd>escape(The number of colors to be plotted, defaults to `7`.
Only used if `plot = True`.)</dd>
 ...
 <dd>escape(Given a str or a list of str,
...
`name`. Uses partial matching, not case sensitive.)</dd>
 ...
 <dd>escape(Similar to `type_`. If not specified
...
returned/plotted.)</dd>
 ...
 <dd>escape(If `False` (default) an object of type
...
defaultpalettes can be provided in addition.)</dd>
 ...
 <dd>escape(Positive int, number of columns, defaults to `4`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.hcl_palettes.hcl_palettes:**kwargs">**kwargs</code>
  </dt>
 <dd>escape(Forwarded to the main
