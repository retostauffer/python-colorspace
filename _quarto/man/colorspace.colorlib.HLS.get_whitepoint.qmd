...
explicitly set via the [set_whitepoint](colorspace.colorlib.HLS.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>HLS.get_whitepoint()</code></pre>
