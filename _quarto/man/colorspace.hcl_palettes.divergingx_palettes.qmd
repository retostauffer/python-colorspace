...
<dl class="pyp-list param-list">
 ...
 <dd>escape(number of colors used when plotting, defaults to `5`.)</dd>
  <dt style = "white-space: nowrap; font-family: monospace; vertical-align: top">
   <code id="colorspace.hcl_palettes.divergingx_palettes:**kwargs">**kwargs</code>
  </dt>
 <dd>escape(forwarded to [hcl_palettes](colorspace.hcl_palettes.hcl_palettes.qmd). For a list and description
