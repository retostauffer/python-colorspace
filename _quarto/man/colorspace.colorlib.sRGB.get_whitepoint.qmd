...
explicitly set via the [set_whitepoint](colorspace.colorlib.sRGB.set_whitepoint.qmd) method, a default white
point is used.

### Usage

<pre><code class='language-python'>sRGB.get_whitepoint()</code></pre>
