...
* Several smaller touch-ups in documentation.
* HTML representation of `hexcols` objects when rendered via jupyter (thx @matteoferla).

## Version 0.4.3 (Mai 2024)
...
* Revamped the entire documentation, now Quarto based and still
    available via https://retostauffer.github.io/python-colorspace/.
    Creaded with help of the https://retostauffer.github.io/pyp2qmd package.
